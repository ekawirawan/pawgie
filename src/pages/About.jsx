  ...
  return (
    <section className="about-section">
      ...
      <div className="about-text">
        <SmContainer>
          <p>
            The Pawgie is a website platform that present information about the
            dog breeds. Feature on this website, namely search, show detail
            information, and add to favorite breeds of dogs that choseed. The{" "}
            <Link target="_blank" to="https://api-ninjas.com">
              API Ninjas
            </Link>{" "}
            is API that using to get the dog breads data. This website was built
            from React and Redux. Copyright 2023 by Eka Wirawan.
          </p>
          <span>
            All of dog data that used on this website are copyrighted. Visit{" "}
            <Link target="_blank" to="https://api-ninjas.com">
              API Ninjas
            </Link>{" "}
            to get licence.
